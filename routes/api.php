...
Route::group(['prefix' => 'marketing'], function () {
    ...
    Route::group(['prefix' => 'marketplace'], function () {
        ...
        Route::post('tools/activate-usage', [\Promolider\Infrastructure\Marketing\In\Http\Controllers\MarketplaceController::class, 'activateToolUsage'])->name('marketing.marketplace.tools.activate')->middleware('auth:sanctum');
        Route::get('my-usages/{courseId}', [\Promolider\Infrastructure\Marketing\In\Http\Controllers\MarketplaceController::class, 'getMyUsages'])->name('marketing.marketplace.my_usages')->middleware('auth:sanctum');
    ...
    Route::get('{type}/{id}/usages', [\Promolider\Infrastructure\Marketing\In\Http\Controllers\MarketingToolsController::class, 'getToolUsages'])->name('marketing.tools.usages')->middleware('auth:sanctum,can:marketing.tools');
