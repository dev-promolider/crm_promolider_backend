...
<head>
    ...
    <title>Acceso a tu E-book - Promolíder</title>
    <style>
        ...
        .info-card { background: #faf5ff; border-left: 4px solid #8b5cf6; border-radius: 10px; padding: 24px; margin: 20px 0; }
        .btn { display: inline-block; background: #8b5cf6; color: #ffffff; text-decoration: none; padding: 16px 32px; border-radius: 8px; font-weight: 600; font-size: 16px; text-align: center; margin: 20px 0; }
    ...
    <table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center">
        <div class="container">
            <div class="header">
                ...
                <p>Tu acceso al e-book está listo</p>
            </div>
            <div class="content">
                <h2 style="margin:0 0 20px;font-size:22px;">¡Hola, {{ $userName }}! 🎉</h2>
                <p style="color:#4a5568;font-size:15px;line-height:1.6;margin:0 0 20px;">Te confirmamos que tu inscripción ha sido exitosa. Estás a un paso de comenzar tu lectura.</p>

                <div class="info-card">
                    <h2 style="color:#2d3748;font-size:20px;margin:0 0 12px;">{{ $ebookTitle }}</h2>
                    <p style="color:#4a5568;font-size:14px;line-height:1.5;margin:0;">{{ $ebookDescription }}</p>
                </div>

                @if($pdfLink)
                <table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center">
                    <a href="{{ $pdfLink }}" class="btn" target="_blank">📚 Acceder al E-book</a>
                </td></tr></table>
                ...
                <div style="background:#f3f4f6;border-radius:6px;padding:15px;margin:20px 0;">
                    ...
                    <div style="background:#ffffff;padding:12px;border:1px solid #d1d5db;border-radius:6px;font-family:monospace;font-size:12px;color:#374151;word-break:break-all;">{{ $pdfLink }}</div>
                </div>
                @endif
            </div>
            <div class="footer">
